...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Avatar World. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Avatar World sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Avatar World' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Avatar World?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Avatar World.</p>
                </div>
            </div>
