...
export const metadata: Metadata = {
    ...
    description: 'Avatar World is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Avatar World accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Avatar World accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Avatar World is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Avatar World presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Avatar World. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@avatarworld.online</strong></li>
                </ul>
                <p>
