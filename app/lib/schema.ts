...
const SITE_URL = 'https://avatarworld.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Avatar World',
        url: SITE_URL,
        description: 'Play Avatar World free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Avatar World online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
