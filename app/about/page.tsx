...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Avatar World',
        url: 'https://avatarworld.online/about',
        description: 'Learn about Avatar World, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Avatar World',
...
export const metadata: Metadata = {
    title: 'About Us – Avatar World',
    description: 'Learn about Avatar World, our mission, and the team behind the game.',
    keywords: ['about Avatar World', 'game team', 'who made Avatar World'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Avatar World</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Avatar World was born from a simple idea: what if playing Avatar World could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Avatar World with a clear vision — to create a free, accessible, and
                    ...
                    Avatar World has something for you.
                </p>
                ...
                <p>
                    Every level in Avatar World is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Avatar World offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Avatar World better for
                    everyone.
                </p>
            </div>
        </>
