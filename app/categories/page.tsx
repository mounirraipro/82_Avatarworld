...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Avatar World puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Avatar World categories'],
  alternates: {
