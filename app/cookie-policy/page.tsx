...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Avatar World uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Avatar World cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Avatar World uses them, and how you can
                ...
                <p>Avatar World uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Avatar World.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@avatarworld.online</strong>.
                </p>
            </div>
        </>
    );
