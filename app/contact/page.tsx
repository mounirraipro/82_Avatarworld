...
const SUPPORT_EMAIL = 'hello@avatarworld.online';

export const metadata: Metadata = {
    title: 'Contact Avatar World',
    description: 'Get in touch with the Avatar World team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Avatar World', 'Avatar World support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
