...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Avatar World disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Avatar World disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Avatar World (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on avatarworld.online
                ...
                <p>
                    Avatar World is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Avatar World displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Avatar World.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Avatar World is not responsible for any errors
